...
OSS-JOURNEY markers plus two generated SVG assets:
...
<circle cx="31" cy="34" r="12" fill="#E3F5DB" stroke="#B9DDAF"/><circle cx="31" cy="34" r="5" fill="#58D453"/>
<text x="55" y="29" class="repo">{xml_escape(display)}</text>
<text x="55" y="50" class="focus">{xml_escape(focus)}</text>
...
<circle cx="26" cy="28" r="10" fill="#E3F5DB" stroke="#B9DDAF"/><circle cx="26" cy="28" r="4" fill="#58D453"/>
<text x="46" y="26" class="repo">{xml_escape(display)}</text>
<text x="46" y="47" class="focus">{xml_escape(focus)}</text>
<g transform="translate(46 61)"><rect width="104" height="27" rx="12" fill="#E2F5DC" stroke="#B8DDB0"/><text x="52" y="18" class="chip" text-anchor="middle">MERGED {merged}</text></g>
<g transform="translate(160 61)"><rect width="94" height="27" rx="12" fill="#F0F4EC" stroke="#D4DED0"/><text x="47" y="18" class="chip" text-anchor="middle">OPEN {open_count}</text></g>
<g transform="translate(264 61)"><rect width="110" height="27" rx="12" fill="#F7F8F4" stroke="#DADFD7"/><text x="55" y="18" class="chip" text-anchor="middle">CLOSED {closed}</text></g>
</g>'''
        )
